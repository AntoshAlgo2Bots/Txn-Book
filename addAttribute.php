    ...
    <div class="mt-10">
        ...
        <form class="max-w-8xl border p-8 mx-auto rounded-xl border-gray-300 shadow-lg" id="myForm">
            <div class="flex flex-wrap justify-between mt-4">
                <div class="mb-3">
                    <label for="s_no" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Serial No</label>
                    <input type="text" id="s_no"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-xs mb-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-24 p-2"
                ...
                <div class="mb-3">
                    <label for="start_date"
                        class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Start Date</label>
                    <input type="date" name="start_date" id="start_date"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-44 p-2"
                        required />
                </div>
                <div class="mb-3">
                    <label for="end_date" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">End Date</label>
            ...
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 mt-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs w-full sm:w-auto px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        </form>
